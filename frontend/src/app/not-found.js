      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <div className="glass p-8 rounded-2xl border border-rose-500/20 shadow-xl max-w-sm mx-auto">
          ...
          <p className="mt-4 text-sm text-slate-500 dark:text-slate-400">
            <strong>System Recovery Note:</strong> This route is currently under
            maintenance or has been deprecated in the modern HAQMS interface.
            Use the fallback connection button below to return to the active
            system.
          </p>

          <div className="mt-8">
            {/* 🔥 FIX: Clean re-route link added to heal the user journey and escape 404 dead ends */}
            <Link
              href="/dashboard"
