...
export default function QueueMonitor() {
  ...
  // 🔥 FIX: Clear cleanup instruction injected to stop duplicate timer mounting memory leaks
  useEffect(() => {
    fetchQueueData();
    ...
    // This runs automatically when the component unmounts to free browser resources
    return () => {
